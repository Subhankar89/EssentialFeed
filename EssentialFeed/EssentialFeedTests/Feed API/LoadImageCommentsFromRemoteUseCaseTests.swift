...
final class LoadImageCommentsFromRemoteUseCaseTests: XCTestCase {
    ...
    func test_load_deliversErrorOn2xxHTTPResponseWithInvalidJSON() {
        ...
        samples.enumerated().forEach { index, code in
            expect(sut, toCompleteWith: failure(.invalidData), when: {
                ...
                client.complete(withStatusCode: code, data: inavlidJSON, at: index)
            })
        }
    }
    ...
    private func makeItem(id: UUID,
                          message: String,
                          createdAt: (date: Date, iso8610String: String),
    ...
    private func expect(
        ...
        line: UInt = #line) {
            ...
            sut.load { receivedResult in
                ...
                case let (.failure(receievedError as RemoteImageCommentsLoader.Error), .failure(expectedError as RemoteImageCommentsLoader.Error)):
